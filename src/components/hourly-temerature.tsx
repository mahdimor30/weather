...
import { useForecast } from "@/query/weather";
import { getSearchParams } from "@/routes/city/loader";

import { Card, CardContent, CardHeader, CardTitle } from "./ui/card";


//TODO use Chart shadcn ui
export function HourlyTemperature() {
  const [search] = useSearchParams();
  const coordinates = getSearchParams(search);
    const { forecast ,forecastLoading,forecastrError} = useForecast(coordinates);

  if (forecastLoading || forecastrError) return null;
